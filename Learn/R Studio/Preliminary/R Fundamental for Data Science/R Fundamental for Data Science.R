...
#[Vector dengan Isi Text](https://academy.dqlab.id/main/livecode/1/4/709)
...
list_satu<-list(1, "Online", nilai_logical="TRUE")
list_satu[[1]]
...
#[Membuat Grafik Sebaran Mahasiswa](https://academy.dqlab.id/main/livecode/1/5/22)
#Membuat dua vector
fakultas <- c("Bisnis", "D3 Perhotelan", "ICT", "Ilmu Komunikasi", "Seni dan Desain")
jumlah_mahasiswa <- c(260, 28, 284, 465, 735)
akreditasi <- c("A","A","B","A","A")
