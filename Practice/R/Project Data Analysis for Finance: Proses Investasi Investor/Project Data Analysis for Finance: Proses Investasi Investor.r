...
#[Cohort Pertama Invest berdasarkan Bulan Register](https://academy.dqlab.id/main/livecode/245/415/2094)
library(dplyr)
library(lubridate)
library(tidyr)
...
#[Cohort Retention Invest](https://academy.dqlab.id/main/livecode/245/415/2095)
library(dplyr)
library(lubridate)
library(tidyr)
